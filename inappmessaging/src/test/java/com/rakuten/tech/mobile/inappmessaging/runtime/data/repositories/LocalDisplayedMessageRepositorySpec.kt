...
//        val message = ValidTestMessage()
//        CampaignRepository.instance().lastSyncMillis = Calendar.getInstance().timeInMillis
//        LocalDisplayedMessageRepository.instance().addMessage(message)
...
//        val message = ValidTestMessage()
//        LocalDisplayedMessageRepository.instance().addMessage(message)
//        CampaignRepository.instance().lastSyncMillis = Calendar.getInstance().timeInMillis + 5
