...
* Improvements:
  ...
  - RMCCX-9685: Remove unnecessary config API retries for invalid response format.
  - RMCCX-9684: Remove unnecessary ping API retries for invalid response format.
  - RMCCX-9696: Remove unnecessary check API retries for 5XX status code.
  - RMCCX-9737: Remove unnecessary check API calls on app launch for invalid response format.
